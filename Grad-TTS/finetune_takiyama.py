...
from data import TextMelJPPhonemeDataset, TextMelBatchCollate
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default="/data/Speech-Backbones/Grad-TTS/checkpts/grad_4500.pt",
    ...
    train_dataset = TextMelJPPhonemeDataset(
        train_filelist_path,
        token_list_path,
        add_blank,
        n_fft,
    ...
    test_dataset = TextMelJPPhonemeDataset(
        valid_filelist_path,
        token_list_path,
        add_blank,
        n_fft,
    ...
    for epoch in range(1, n_epochs + 1):
        train_one_epoch(iteration, epoch, model, loader, train_dataset, batch_size)
        val_loss = validate(iteration, epoch, model, loader, test_dataset, batch_size)
